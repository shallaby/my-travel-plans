...
c.src=a}
;var Ye={},Ze=0;
function $e(a,b,c,d,e,f){f=f||{};f.name=c||Q("INNERTUBE_CONTEXT_CLIENT_NAME",1);f.version=d||Q("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0);b=void 0===b?"ERROR":b;e=void 0===e?!1:e;e=window&&window.yterr||(void 0===e?!1:e)||!1;if(a&&e&&!(5<=Ze)){e=a.stacktrace;c=a.columnNumber;d=v("window.location.href");if(r(a))a={message:a,name:"Unknown error",lineNumber:"Not available",fileName:d,stack:"Not available"};else{var g=!1;try{var h=a.lineNumber||a.line||"Not available"}catch(M){h="Not available",g=!0}try{var l=
a.fileName||a.filename||a.sourceURL||p.$googDebugFname||d}catch(M){l="Not available",g=!0}a=!g&&a.lineNumber&&a.fileName&&a.stack&&a.message&&a.name?a:{message:a.message||"Not available",name:a.name||"UnknownError",lineNumber:h,fileName:l,stack:a.stack||"Not available"}}e=e||a.stack;h=a.lineNumber.toString();isNaN(h)||isNaN(c)||(h=h+":"+c);if(!(Ye[a.message]||0<=e.indexOf("/YouTubeCenter.js")||0<=e.indexOf("/mytube.js"))){l=e;h={bb:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,1E3),
...
var jg={enablejsapi:1},kg={},lg={allowscriptaccess:"always",allowfullscreen:"true",bgcolor:"#000000"};ig.prototype.clone=function(){var a=new ig,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];a[b]="object"==oa(c)?$a(c):c}return a};function mg(){G.call(this);this.b=[]}
n(mg,G);mg.prototype.m=function(){for(;this.b.length;){var a=this.b.pop();a.target.removeEventListener(a.name,a.fb)}G.prototype.m.call(this)};var ng=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function og(a){a=a||"";if(window.spf){var b=a.match(ng);spf.style.load(a,b?b[1]:"",void 0)}else pg(a)}
function pg(a){var b=qg(a),c=document.getElementById(b),d=c&&ce(c,"loaded");d||c&&!d||(c=rg(a,b,function(){ce(c,"loaded")||(ae(c),me(b),U(y(ne,b),0))}))}
...
function qg(a){var b=document.createElement("A");a=xb(a);Bb(b,a);b=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Oa(b)}
;var sg=v("ytLoggingLatencyUsageStats_")||{};t("ytLoggingLatencyUsageStats_",sg,void 0);var tg=0;function ug(a){sg[a]=sg[a]||{count:0};var b=sg[a];b.count++;b.time=O();tg||(tg=df(vg,5E3));return 10<b.count?(11==b.count&&$e(Error("CSI data exceeded logging limit with key: "+a),0==a.indexOf("info")?"WARNING":"ERROR"),!0):!1}
function vg(){var a=O(),b;for(b in sg)6E4<a-sg[b].time&&delete sg[b];tg=0}
;function wg(a,b){this.version=a;this.args=b}
;function xg(a){this.topic=a}
xg.prototype.toString=function(){return this.topic};var yg=v("ytPubsub2Pubsub2Instance")||new I;I.prototype.subscribe=I.prototype.subscribe;I.prototype.unsubscribeByKey=I.prototype.L;I.prototype.publish=I.prototype.J;I.prototype.clear=I.prototype.clear;t("ytPubsub2Pubsub2Instance",yg,void 0);t("ytPubsub2Pubsub2SubscribedKeys",v("ytPubsub2Pubsub2SubscribedKeys")||{},void 0);t("ytPubsub2Pubsub2TopicToKeys",v("ytPubsub2Pubsub2TopicToKeys")||{},void 0);t("ytPubsub2Pubsub2IsAsync",v("ytPubsub2Pubsub2IsAsync")||{},void 0);
t("ytPubsub2Pubsub2SkipSubKey",null,void 0);function zg(a,b){var c=v("ytPubsub2Pubsub2Instance");c&&c.publish.call(c,a.toString(),a,b)}
;var X=window.performance||window.mozPerformance||window.msPerformance||window.webkitPerformance||{};function Ag(){var a=Q("TIMING_TICK_EXPIRATION");a||(a={},P("TIMING_TICK_EXPIRATION",a));return a}
function Bg(){var a=Ag(),b;for(b in a)hf(a[b]);P("TIMING_TICK_EXPIRATION",{})}
;function Cg(a,b){wg.call(this,1,arguments)}
n(Cg,wg);function Dg(a,b){wg.call(this,1,arguments)}
n(Dg,wg);var Eg=new xg("aft-recorded"),Fg=new xg("timing-sent");var Gg={vc:!0},Hg={ad_allowed:"adTypesAllowed",ad_at:"adType",ad_cpn:"adClientPlaybackNonce",ad_docid:"adVideoId",yt_ad_an:"adNetworks",p:"httpProtocol",t:"transportProtocol",cpn:"clientPlaybackNonce",csn:"clientScreenNonce",docid:"videoId",is_nav:"isNavigation",yt_lt:"loadType",yt_ad:"isMonetized",nr:"webInfo.navigationReason",ncnp:"webInfo.nonPreloadedNodeCount",paused:"playerInfo.isPausedOnLoad",fmt:"playerInfo.itag",yt_pl:"watchInfo.isPlaylist",yt_ad_pr:"prerollAllowed",yt_red:"isRedSubscriber",
...
Mg=!1;
function Ng(a){if("_"!=a[0]){var b=a;X.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),X.mark(b))}b=Og();var c=O();b[a]&&(b["_"+a]=b["_"+a]||[b[a]],b["_"+a].push(c));b[a]=c;b=Ag();if(c=b[a])hf(c),b[a]=0;Pg()["tick_"+a]=void 0;O();Qg()?(b=Rg(),"_start"==a?ug("baseline_"+b)||Mf("latencyActionBaselined",{clientActionNonce:b},void 0,void 0):ug("tick_"+a+"_"+b)||Mf("latencyActionTicked",{tickName:a,clientActionNonce:b},void 0,void 0),a=!0):a=!1;if(a=!a)a=!v("yt.timing.pingSent_");if(a&&(b=Yd("TIMING_ACTION"),a=
Og(),v("ytglobal.timingready_")&&b&&a._start&&(b=Sg()))){S("tighter_critical_section")&&!Mg&&(zg(Eg,new Cg(Math.round(b-a._start),void 0)),Mg=!0);b=!0;c=Q("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}b&&Tg()}}
function Ug(){var a=Vg().info.yt_lt="hot_bg";Pg().info_yt_lt=a;if(Qg())if("yt_lt"in Hg){var b=Hg.yt_lt;0<=xa(Lg,b)&&(a=!!a);if(Qg()){var c={};b=b.split(".");for(var d=c,e=0;e<b.length-1;e++)d[b[e]]=d[b[e]]||{},d=d[b[e]];d[b[b.length-1]]=a;a=Rg();b=Object.keys(c).join("");ug("info_"+b+"_"+a)||(c.clientActionNonce=a,Mf("latencyActionInfo",c,void 0,void 0))}}else 0<=xa(Kg,"yt_lt")||R(Error("Unknown label yt_lt logged with GEL CSI."))}
function Sg(){var a=Og();if(a.aft)return a.aft;for(var b=Q("TIMING_AFT_KEYS",["ol"]),c=b.length,d=0;d<c;d++){var e=a[b[d]];if(e)return e}return NaN}
function Tg(){Bg();if(!Qg()){var a=Og(),b=Vg().info,c=a._start,d;for(d in a)if(0==d.lastIndexOf("_",0)&&w(a[d])){var e=d.slice(1);if(e in Gg){var f=za(a[d],function(a){return Math.round(a-c)});
b["all_"+e]=f.join()}delete a[d]}e=!!b.ap;if(f=v("ytglobal.timingReportbuilder_")){if(f=f(a,b,void 0))Wg(f,e),Xg(),Yg(),Zg(!1,void 0),Q("TIMING_ACTION")&&P("PREVIOUS_ACTION",Q("TIMING_ACTION")),P("TIMING_ACTION","")}else{var g=Q("CSI_SERVICE_NAME","youtube");f={v:2,s:g,action:Q("TIMING_ACTION",void 0)};var h=b.srt;void 0!==a.srt&&delete b.srt;if(b.h5jse){var l=window.location.protocol+v("ytplayer.config.assets.js");(l=X.getEntriesByName?X.getEntriesByName(l)[0]:null)?b.h5jse=Math.round(b.h5jse-l.responseEnd):
delete b.h5jse}a.aft=Sg();$g()&&"youtube"==g&&(Ug(),g=a.vc,l=a.pbs,delete a.aft,b.aft=Math.round(l-g));for(var m in b)"_"!=m.charAt(0)&&(f[m]=b[m]);a.ps=O();b={};m=[];for(d in a)"_"!=d.charAt(0)&&(g=Math.round(a[d]-c),b[d]=g,m.push(d+"."+g));f.rt=m.join(",");(a=v("ytdebug.logTiming"))&&a(f,b);Wg(f,e,void 0);zg(Fg,new Dg(b.aft+(h||0),void 0))}}}
var Yg=x(X.clearResourceTimings||X.webkitClearResourceTimings||X.mozClearResourceTimings||X.msClearResourceTimings||X.oClearResourceTimings||ma,X);
function Wg(a,b,c){if(S("debug_csi_data")){var d=v("yt.timing.csiData");d||(d=[],t("yt.timing.csiData",d,void 0));d.push({page:location.href,time:new Date,args:a})}d="";for(var e in a)d+="&"+e+"="+a[e];a="/csi_204?";S("redirect_csi_204_to_qoe")&&(a="/api/stats/qoe?",d+="&redirect_csi_204_to_qoe=true");a+=d.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b){var f=void 0===f?"":f;try{window.navigator&&window.navigator.sendBeacon&&window.navigator.sendBeacon(a,f)||We(a,void 0,void 0,void 0,
f)}catch(g){We(a,void 0,void 0,void 0,f)}}else We(a);Zg(!0,c)}
function Rg(){var a=Vg().nonce;a||(a=Yf(),Vg().nonce=a);return a}
function Og(){return Vg().tick}
function Pg(){var a=Vg();"gel"in a||(a.gel={});return a.gel}
function Vg(){return v("ytcsi.data_")||Xg()}
function Xg(){var a={tick:{},info:{}};t("ytcsi.data_",a,void 0);return a}
function Zg(a,b){t("yt.timing."+(b||"")+"pingSent_",a,void 0)}
function $g(){var a=Og(),b=a.pbr,c=a.vc;a=a.pbs;return b&&c&&a&&b<c&&c<a&&1==Vg().info.yt_pvis}
function Qg(){return!!S("csi_on_gel")}
;function ah(a,b){G.call(this);this.l=this.T=a;this.H=b;this.o=!1;this.f={};this.R=this.G=null;this.w=new I;tc(this,y(uc,this.w));this.i={};this.O=this.S=this.g=this.Y=this.b=null;this.N=!1;this.j=this.D=null;this.U={};this.ua=["onReady"];this.X=null;this.ka=NaN;this.P={};bh(this);this.V("WATCH_LATER_VIDEO_ADDED",this.La.bind(this));this.V("WATCH_LATER_VIDEO_REMOVED",this.Ma.bind(this));this.V("onAdAnnounce",this.ya.bind(this));this.va=new mg(this);tc(this,y(uc,this.va))}
n(ah,G);k=ah.prototype;
k.ha=function(a){if(!this.h){a instanceof ig||(a=new ig(a));this.Y=a;this.b=a.clone();this.g=this.b.attrs.id||this.g;"video-player"==this.g&&(this.g=this.H,this.b.attrs.id=this.H);this.l.id==this.g&&(this.g+="-player",this.b.attrs.id=this.g);this.b.args.enablejsapi="1";this.b.args.playerapiid=this.H;this.S||(this.S=ch(this,this.b.args.jsapicallback||"onYouTubePlayerReady"));this.b.args.jsapicallback=null;if(a=this.b.attrs.width)this.l.style.width=Sb(Number(a)||a);if(a=this.b.attrs.height)this.l.style.height=Sb(Number(a)||
a);dh(this);this.o&&eh(this)}};
k.Ba=function(){return this.Y};
function eh(a){a.b.loaded||(a.b.loaded=!0,"0"!=a.b.args.autoplay?a.f.loadVideoByPlayerVars(a.b.args):a.f.cueVideoByPlayerVars(a.b.args))}
function fh(a){var b=!0,c=gh(a);c&&a.b&&(a=a.b,b=ce(c,"version")==a.assets.js);return b&&!!v("yt.player.Application.create")}
function dh(a){if(!a.h&&!a.N){var b=fh(a);if(b&&"html5"==(gh(a)?"html5":null))a.O="html5",a.o||hh(a);else if(ih(a),a.O="html5",b&&a.j)a.T.appendChild(a.j),hh(a);else{a.b.loaded=!0;var c=!1;a.D=function(){c=!0;var b=a.b.clone();v("yt.player.Application.create")(a.T,b);hh(a)};
a.N=!0;b?a.D():(re(a.b.assets.js,a.D),og(a.b.assets.css),jh(a)&&!c&&t("yt.player.Application.create",null,void 0))}}}
function gh(a){var b=Gb(a.g);!b&&a.l&&a.l.querySelector&&(b=a.l.querySelector("#"+a.g));return b}
function hh(a){if(!a.h){var b=gh(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.N=!1,b.isNotServable&&b.isNotServable(a.b.args.video_id)||kh(a)):a.ka=U(function(){hh(a)},50)}}
function kh(a){bh(a);a.o=!0;var b=gh(a);b.addEventListener&&(a.G=lh(a,b,"addEventListener"));b.removeEventListener&&(a.R=lh(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.f[e]||(a.f[e]=lh(a,b,e))}for(var f in a.i)a.G(f,a.i[f]);eh(a);a.S&&a.S(a.f);a.w.J("onReady",a.f)}
function lh(a,b,c){var d=b[c];return function(){try{return a.X=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.X=e,R(e,"WARNING",void 0,void 0,void 0))}}}
function bh(a){a.o=!1;if(a.R)for(var b in a.i)a.R(b,a.i[b]);for(var c in a.P)ee(parseInt(c,10));a.P={};a.G=null;a.R=null;for(var d in a.f)a.f[d]=null;a.f.addEventListener=a.V.bind(a);a.f.removeEventListener=a.Sa.bind(a);a.f.destroy=a.dispose.bind(a);a.f.getLastError=a.Ca.bind(a);a.f.getPlayerType=a.Da.bind(a);a.f.getCurrentVideoConfig=a.Ba.bind(a);a.f.loadNewVideoConfig=a.ha.bind(a);a.f.isReady=a.Ka.bind(a)}
k.Ka=function(){return this.o};
k.V=function(a,b){var c=this,d=ch(this,b);if(d){if(!(0<=xa(this.ua,a)||this.i[a])){var e=mh(this,a);this.G&&this.G(a,e)}this.w.subscribe(a,d);"onReady"==a&&this.o&&U(function(){d(c.f)},0)}};
k.Sa=function(a,b){if(!this.h){var c=ch(this,b);c&&ld(this.w,a,c)}};
function ch(a,b){var c=b;if("string"==typeof b){if(a.U[b])return a.U[b];c=function(){var a=v(b);a&&a.apply(p,arguments)};
a.U[b]=c}return c?c:null}
function mh(a,b){var c="ytPlayer"+b+a.H;a.i[b]=c;p[c]=function(c){var d=a.b&&a.b.args&&a.b.args.fflags;if(d&&0>d.indexOf("use_html5_player_event_timeout=true"))a.w.J(b,c);else{var f=U(function(){if(!a.h){a.w.J(b,c);var d=a.P,e=String(f);e in d&&delete d[e]}},0);
Za(a.P,String(f))}};
return c}
...
k.Da=function(){return this.O||(gh(this)?"html5":null)};
k.Ca=function(){return this.X};
function ih(a){Ng("dcp");a.cancel();bh(a);a.O=null;a.b&&(a.b.loaded=!1);var b=gh(a);b&&(fh(a)||!jh(a)?a.j=b:(b&&b.destroy&&b.destroy(),a.j=null));for(a=a.T;b=a.firstChild;)a.removeChild(b)}
k.cancel=function(){this.D&&xe(this.b.assets.js,this.D);ee(this.ka);this.N=!1};
k.m=function(){ih(this);if(this.j&&this.b&&this.j.destroy)try{this.j.destroy()}catch(b){R(b)}this.U=null;for(var a in this.i)p[this.i[a]]=null;this.Y=this.b=this.f=null;delete this.T;delete this.l;G.prototype.m.call(this)};
function jh(a){return a.b&&a.b.args&&a.b.args.fflags?-1!=a.b.args.fflags.indexOf("player_destroy_old_version=true"):!1}
;var nh={},oh="player_uid_"+(1E9*Math.random()>>>0);function ph(a){var b="player";b=r(b)?Gb(b):b;var c=oh+"_"+(b[sa]||(b[sa]=++ta)),d=nh[c];if(d)return d.ha(a),d.f;d=new ah(b,c);nh[c]=d;me("player-added",d.f);tc(d,y(qh,d));U(function(){d.ha(a)},0);
return d.f}
function qh(a){delete nh[a.H]}
;function rh(){var a=sh(),b=th();if(!a&&!b||!window.JSON)return null;try{var c=a.get("yt-player-two-stage-token")}catch(d){}if(!r(c))try{c=b.get("yt-player-two-stage-token")}catch(d){}if(!r(c))return null;try{c=JSON.parse(c,void 0)}catch(d){}return c}
var th=Mb(function(){var a=new wd;return a.isAvailable()?new sd(a):null}),sh=Mb(function(){var a=new xd;
return a.isAvailable()?new sd(a):null});function uh(a){return(0==a.search("cue")||0==a.search("load"))&&"loadModule"!=a}
function vh(a,b,c){r(a)&&(a={mediaContentUrl:a,startSeconds:b,suggestedQuality:c});b=/\/([ve]|embed)\/([^#?]+)/.exec(a.mediaContentUrl);a.videoId=b&&b[2]?b[2]:null;return wh(a)}
function wh(a,b,c){if(ra(a)){b="endSeconds startSeconds mediaContentUrl suggestedQuality videoId two_stage_token".split(" ");c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}return{videoId:a,startSeconds:b,suggestedQuality:c}}
function xh(a,b,c,d){if(ra(a)&&!w(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};r(a)&&16==a.length?b.list="PL"+a:b.playlist=a;return b}
function yh(a){var b=a.video_id||a.videoId;if(r(b)){var c=rh()||{},d=rh()||{};q(void 0)?d[b]=void 0:delete d[b];var e=z()+3E5,f=th();if(f&&window.JSON){r(d)||(d=JSON.stringify(d,void 0));try{f.set("yt-player-two-stage-token",d,e)}catch(g){f.remove("yt-player-two-stage-token")}}(b=c[b])&&(a.two_stage_token=b)}}
;function zh(a){G.call(this);this.b=a;this.b.subscribe("command",this.ra,this);this.f={};this.i=!1}
A(zh,G);k=zh.prototype;k.start=function(){this.i||this.h||(this.i=!0,Ah(this.b,"RECEIVING"))};
k.ra=function(a,b,c){if(this.i&&!this.h){var d=b||{};switch(a){case "addEventListener":r(d.event)&&(a=d.event,a in this.f||(c=x(this.Ua,this,a),this.f[a]=c,this.addEventListener(a,c)));break;case "removeEventListener":r(d.event)&&Bh(this,d.event);break;default:this.g.isReady()&&this.g[a]&&(b=Ch(a,b||{}),c=this.g.handleExternalCall(a,b,c||null),(c=Dh(a,c))&&this.i&&!this.h&&Ah(this.b,a,c))}}};
k.Ua=function(a,b){this.i&&!this.h&&Ah(this.b,a,this.ba(a,b))};
k.ba=function(a,b){if(null!=b)return{value:b}};
function Bh(a,b){b in a.f&&(a.removeEventListener(b,a.f[b]),delete a.f[b])}
k.m=function(){var a=this.b;a.h||ld(a.b,"command",this.ra,this);this.b=null;for(var b in this.f)Bh(this,b);zh.u.m.call(this)};function Eh(a,b){zh.call(this,b);this.g=a;this.start()}
A(Eh,zh);Eh.prototype.addEventListener=function(a,b){this.g.addEventListener(a,b)};
Eh.prototype.removeEventListener=function(a,b){this.g.removeEventListener(a,b)};
function Ch(a,b){switch(a){case "loadVideoById":return b=wh(b),yh(b),[b];case "cueVideoById":return b=wh(b),yh(b),[b];case "loadVideoByPlayerVars":return yh(b),[b];case "cueVideoByPlayerVars":return yh(b),[b];case "loadPlaylist":return b=xh(b),yh(b),[b];case "cuePlaylist":return b=xh(b),yh(b),[b];case "seekTo":return[b.seconds,b.allowSeekAhead];case "playVideoAt":return[b.index];case "setVolume":return[b.volume];case "setPlaybackQuality":return[b.suggestedQuality];case "setPlaybackRate":return[b.suggestedRate];
...
Eh.prototype.ba=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return Eh.u.ba.call(this,a,b)};
Eh.prototype.m=function(){Eh.u.m.call(this);delete this.g};function Fh(a,b,c,d){G.call(this);this.f=b||null;this.o="*";this.g=c||null;this.sessionId=null;this.channel=d||null;this.D=!!a;this.l=x(this.w,this);window.addEventListener("message",this.l)}
n(Fh,G);Fh.prototype.w=function(a){if(!("*"!=this.g&&a.origin!=this.g||this.f&&a.source!=this.f)&&r(a.data)){try{var b=JSON.parse(a.data)}catch(c){return}if(!(null==b||this.D&&(this.sessionId&&this.sessionId!=b.id||this.channel&&this.channel!=b.channel))&&b)switch(b.event){case "listening":"null"!=a.origin&&(this.g=this.o=a.origin);this.f=a.source;this.sessionId=b.id;this.b&&(this.b(),this.b=null);break;case "command":this.i&&(!this.j||0<=xa(this.j,b.func))&&this.i(b.func,b.args,a.origin)}}};
Fh.prototype.sendMessage=function(a,b){var c=b||this.f;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=Ic(a);c.postMessage(d,this.o)}catch(e){R(e,"WARNING")}}};
Fh.prototype.m=function(){window.removeEventListener("message",this.l);G.prototype.m.call(this)};function Gh(a,b,c){Fh.call(this,a,b,c||Q("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname,"widget");this.j=this.b=this.i=null}
n(Gh,Fh);function Hh(){var a=this.f=new Gh(!!Q("WIDGET_ID_ENFORCE")),b=x(this.Oa,this);a.i=b;a.j=null;this.f.channel="widget";if(a=Q("WIDGET_ID"))this.f.sessionId=a;this.g=[];this.j=!1;this.i={}}
k=Hh.prototype;k.Oa=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.i[a]||"onReady"==a||(this.addEventListener(a,Ih(this,a)),this.i[a]=!0)):this.ta(a,b,c)};
k.ta=function(){};
...
k.dispose=function(){this.f=null};function Kh(a){Hh.call(this);this.b=a;this.h=[];this.addEventListener("onReady",x(this.Na,this));this.addEventListener("onVideoProgress",x(this.Ya,this));this.addEventListener("onVolumeChange",x(this.Za,this));this.addEventListener("onApiChange",x(this.Ta,this));this.addEventListener("onPlaybackQualityChange",x(this.Va,this));this.addEventListener("onPlaybackRateChange",x(this.Wa,this));this.addEventListener("onStateChange",x(this.Xa,this));this.addEventListener("onWebglSettingsChanged",x(this.ab,
this))}
A(Kh,Hh);k=Kh.prototype;k.ta=function(a,b,c){if(this.b[a]){b=b||[];if(0<b.length&&uh(a)){var d=b;if(ra(d[0])&&!w(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=wh.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=vh.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=xh.apply(window,d)}d=e}yh(d);b.length=1;b[0]=d}this.b.handleExternalCall(a,b,c);uh(a)&&Jh(this,this.ca())}};
k.Na=function(){var a=x(this.Aa,this);this.f.b=a};
...
k.Va=function(a){Jh(this,{playbackQuality:a})};
k.Wa=function(a){Jh(this,{playbackRate:a})};
...
k.Za=function(){Jh(this,{muted:this.b.isMuted(),volume:this.b.getVolume()})};
k.Ya=function(a){a={currentTime:a,videoBytesLoaded:this.b.getVideoBytesLoaded(),videoLoadedFraction:this.b.getVideoLoadedFraction(),currentTimeLastUpdated_:z()/1E3,playbackRate:this.b.getPlaybackRate(),mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getProgressState&&(a.progressState=this.b.getProgressState());Jh(this,a)};
k.ab=function(){if(this.b.getSphericalProperties){var a={sphericalProperties:this.b.getSphericalProperties()};Jh(this,a)}};
k.dispose=function(){Kh.u.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.b.removeEventListener(b.eventType,b.listener)}this.h=[]};function Lh(){G.call(this);this.b=new I;tc(this,y(uc,this.b))}
A(Lh,G);Lh.prototype.subscribe=function(a,b,c){return this.h?0:this.b.subscribe(a,b,c)};
Lh.prototype.j=function(a,b){this.h||this.b.J.apply(this.b,arguments)};function Mh(a,b,c){Lh.call(this);this.f=a;this.g=b;this.i=c}
A(Mh,Lh);function Ah(a,b,c){if(!a.h){var d=a.f;d.h||a.g!=d.b||(a={id:a.i,command:b},c&&(a.data=c),d.b.postMessage(Ic(a),d.g))}}
Mh.prototype.m=function(){this.g=this.f=null;Mh.u.m.call(this)};function Nh(a,b,c){G.call(this);this.b=a;this.g=c;this.i=V(window,"message",x(this.j,this));this.f=new Mh(this,a,b);tc(this,y(uc,this.f))}
...
Nh.prototype.m=function(){tf(this.i);this.b=null;Nh.u.m.call(this)};function Oh(){var a=$a(Ph),b;return bd(new H(function(c,d){a.A=function(a){Fe(a)?c(a):d(new Qh("Request failed, status="+a.status,"net.badstatus",a))};
a.onError=function(a){d(new Qh("Unknown request error","net.unknown",a))};
a.M=function(a){d(new Qh("Request timed out","net.timeout",a))};
b=Ne("//googleads.g.doubleclick.net/pagead/id",a)}),function(a){a instanceof cd&&b.abort();
return Uc(a)})}
function Qh(a,b){B.call(this,a+", errorCode="+b);this.errorCode=b;this.name="PromiseAjaxError"}
n(Qh,B);function Rh(a){this.h=void 0===a?null:a;this.f=0;this.b=null}
Rh.prototype.then=function(a,b,c){return this.h?this.h.then(a,b,c):1===this.f&&a?(a=a.call(c,this.b),Pc(a)?a:Sh(a)):2===this.f&&b?(a=b.call(c,this.b),Pc(a)?a:Th(a)):this};
Rh.prototype.getValue=function(){return this.b};
Oc(Rh);function Th(a){var b=new Rh;a=void 0===a?null:a;b.f=2;b.b=void 0===a?null:a;return b}
function Sh(a){var b=new Rh;a=void 0===a?null:a;b.f=1;b.b=void 0===a?null:a;return b}
;function Uh(a){B.call(this,a.message||a.description||a.name);this.isMissing=a instanceof Vh;this.isTimeout=a instanceof Qh&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof cd}
n(Uh,B);Uh.prototype.name="BiscottiError";function Vh(){B.call(this,"Biscotti ID is missing from server")}
n(Vh,B);Vh.prototype.name="BiscottiMissingError";var Ph={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Wh=null;function Xh(){if("1"===Va(Zd(),"args","privembed"))return Uc(Error("Biscotti ID is not available in private embed mode"));Wh||(Wh=bd(Oh().then(Yh),function(a){return Zh(2,a)}));
return Wh}
function Yh(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new Vh;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new Vh;a=a.id;$h(a);Wh=Sh(a);ai(18E5,2);return a}
function Zh(a,b){var c=new Uh(b);$h("");Wh=Th(c);0<a&&ai(12E4,a-1);throw c;}
function ai(a,b){U(function(){bd(Oh().then(Yh,function(a){return Zh(b,a)}),ma)},a)}
function $h(a){t("yt.ads.biscotti.lastId_",a,void 0)}
function bi(){try{var a=v("yt.ads.biscotti.getId_");return a?a():Xh()}catch(b){return Uc(b)}}
;function ci(a){B.apply(this,arguments)}
n(ci,B);ci.prototype.name="YuzuError";function di(){var a=new ci("ID is missing"),b=new ci("Timeout"),c=null,d=!1;Vd(function(){c=Td();d=!0});
if(d)return c?Sh(c):Th(a);var e=new H(function(b,c){Vd(function(){var d=Td();d?b(d):c(a)})}),f=Fd().then(function(){return Uc(b)});
return $c(Xc([e,f]),function(){return f.cancel()})}
;function ei(a){if("1"!==Va(Zd(),"args","privembed")){a&&(v("yt.ads.biscotti.getId_")||wa("yt.ads.biscotti.getId_",Xh));try{var b=bi();if(S("enable_yuzu")){v("yt.ads.yuzu.getId_")||t("yt.ads.yuzu.getId_",di,void 0);try{var c=v("yt.ads.yuzu.getId_")()}catch(d){c=Uc(d)}}else c=Uc(new ci("unimplemented"));Yc([b,c]).then(function(a){var b=a[0];a=a[1];if(b.Z||a.Z){b=b.value;a=a.value;var c={};c.dt=Tb;c.flash="0";a:{try{var d=window.top.location.href}catch(Ta){d=2;break a}d=null!=d?d==window.document.location.href?
...
F.navigator.mimeTypes.length);d.ca_type="image";if(S("enable_server_side_search_pyv")||S("enable_server_side_mweb_search_pyv")){l=window;try{var m=l.screenX;var u=l.screenY}catch(Ta){}try{var M=l.outerWidth;var Z=l.outerHeight}catch(Ta){}try{var Ig=l.innerWidth;var Jg=l.innerHeight}catch(Ta){}m=[l.screenLeft,l.screenTop,m,u,l.screen?l.screen.availWidth:void 0,l.screen?l.screen.availTop:void 0,M,Z,Ig,Jg];u=window.top;try{var T=(u||window).document,Sa="CSS1Compat"==T.compatMode?T.documentElement:T.body;
var Fa=(new Fb(Sa.clientWidth,Sa.clientHeight)).round()}catch(Ta){Fa=new Fb(-12245933,-12245933)}T={};Sa=0;p.SVGElement&&p.document.createElementNS&&(Sa|=1);T.bc=Sa;T.bih=Fa.height;T.biw=Fa.width;T.brdim=m.join();Fa=(T.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[Rb.visibilityState||Rb.webkitVisibilityState||Rb.mozVisibilityState||""]||0,T.wgl=!!F.WebGLRenderingContext,T);for(var Ld in Fa)d[Ld]=Fa[Ld]}void 0!==b&&(d.bid=b);void 0!==a&&(d.anid=a);d.bsq=fi++;Te("//www.youtube.com/ad_data_204",
{Ea:!1,B:d,withCredentials:!0})}});
U(ei,18E5)}catch(d){R(d)}}}
var fi=0;var Y=v("ytglobal.prefsUserPrefsPrefs_")||{};t("ytglobal.prefsUserPrefsPrefs_",Y,void 0);function gi(){this.b=Q("ALT_PREF_COOKIE_NAME","PREF");var a=Zb.get(""+this.b,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Y[d]=c.toString())}}}
k=gi.prototype;k.get=function(a,b){hi(a);ii(a);var c=void 0!==Y[a]?Y[a].toString():null;return null!=c?c:b?b:""};
k.set=function(a,b){hi(a);ii(a);if(null==b)throw Error("ExpectedNotNull");Y[a]=b.toString()};
k.remove=function(a){hi(a);ii(a);delete Y[a]};
...
function ji(a){a=void 0!==Y[a]?Y[a].toString():null;return null!=a&&/^[A-Fa-f0-9]+$/.test(a)?parseInt(a,16):null}
na(gi);var ki=null,li=null,mi=null,ni={};function oi(a){Mf(a.payload_name,a.payload,void 0,void 0)}
function pi(a){var b=a.id;a=a.ve_type;var c=bg++;a=new $f(void 0,a,c,void 0,void 0);ni[b]=a;b=dg();c=cg();b&&c&&gg(b,c,a)}
function qi(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(eg(b,a),a=cg()))for(var c in ni){var d=ni[c];d&&gg(b,a,d)}}
function ri(a){ni[a.id]=new $f(a.tracking_params)}
function si(a){var b=dg();a=ni[a.id];b&&a&&(S("interaction_click_on_gel_web")?Mf("visualElementGestured",{csn:b,ve:ag(a),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"}):hg({click:{csn:b,visualElement:ag(a)}}))}
function ti(a){a=a.ids;var b=dg();if(b)for(var c=0;c<a.length;c++){var d=ni[a[c]];d&&Mf("visualElementShown",{csn:b,ve:ag(d),eventType:1})}}
...
t("writeEmbed",function(){var a=Q("PLAYER_CONFIG",void 0);ei(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=Q("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);Q("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");a.args.autoplay&&yh(a.args);ki=a=ph(a);a.addEventListener("onScreenChanged",qi);a.addEventListener("onLogClientVeCreated",pi);a.addEventListener("onLogServerVeCreated",ri);a.addEventListener("onLogToGel",oi);
a.addEventListener("onLogVeClicked",si);a.addEventListener("onLogVesShown",ti);a.addEventListener("onReady",ui);b=Q("POST_MESSAGE_ID","player");Q("ENABLE_JS_API")?mi=new Kh(a):Q("ENABLE_POST_API")&&r(b)&&r(c)&&(li=new Nh(window.parent,b,c),mi=new Eh(a,li.f));Q("BG_P")&&(Q("BG_I")||Q("BG_IU"))&&ze();lf()},void 0);
t("yt.www.watch.ads.restrictioncookie.spr",function(a){We(a+"mac_204?action_fcts=1");return!0},void 0);
var vi=$d(function(){Ng("ol");var a=gi.getInstance(),b=!!((ji("f"+(Math.floor(119/31)+1))||0)&67108864),c=1<window.devicePixelRatio;if(document.body&&xc(document.body,"exp-invert-logo"))if(c&&!xc(document.body,"inverted-hdpi")){var d=document.body;d.classList?d.classList.add("inverted-hdpi"):xc(d,"inverted-hdpi")||(d.className+=0<d.className.length?" inverted-hdpi":"inverted-hdpi")}else!c&&xc(document.body,"inverted-hdpi")&&yc();b!=c&&(b="f"+(Math.floor(119/31)+1),d=ji(b)||0,d=c?d|67108864:d&-67108865,
0==d?delete Y[b]:Y[b]=d.toString(16).toString(),a.save())}),wi=$d(function(){var a=ki;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();Q("PL_ATT")&&(ye=null);a=0;for(var b=jf.length;a<b;a++)hf(jf[a]);jf.length=0;we("//static.doubleclick.net/instream/ad_status.js");kf=!1;P("DCLKSTAT",0);vc(mi,li);if(a=ki)a.removeEventListener("onScreenChanged",qi),a.removeEventListener("onLogClientVeCreated",pi),a.removeEventListener("onLogServerVeCreated",ri),a.removeEventListener("onLogToGel",oi),a.removeEventListener("onLogVeClicked",si),a.removeEventListener("onLogVesShown",ti),a.removeEventListener("onReady",
ui),a.destroy();ni={}});
window.addEventListener?(window.addEventListener("load",vi),window.addEventListener("unload",wi)):window.attachEvent&&(window.attachEvent("onload",vi),window.attachEvent("onunload",wi));wa("yt.abuse.botguardInitialized",v("yt.abuse.botguardInitialized")||Be);wa("yt.abuse.invokeBotguard",v("yt.abuse.invokeBotguard")||Ce);wa("yt.abuse.dclkstatus.checkDclkStatus",v("yt.abuse.dclkstatus.checkDclkStatus")||mf);wa("yt.player.exports.navigate",v("yt.player.exports.navigate")||fg);
